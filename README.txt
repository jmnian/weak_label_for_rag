...
Step 3. Train Retriever 
    Before start training, make sure to make train_groundtruth_allones.tsv and val.tsv and test.tsv. Scripts are in /data_workers/
        dpr weak -> python train_retriever/train_dpr_weak.py --data_path="/WAVE/users2/unix/jnian/WeakLabelForRAG/data/msmarco_qa_v2_train_corpus500000_weakTrainQ1200_ValQ10000" --weak_label_path="/llama3_old_prompt" --num_hard_neg=10 --num_epochs=16 --encoder_name="bert-base-uncased" --product="cosine" --loss="triplet"
        dpr gt   -> python train_retriever/train_dpr_gt.py --data_path="/WAVE/users2/unix/jnian/WeakLabelForRAG/data/msmarco_qa_v2_train_corpus500000_weakTrainQ1200_ValQ10000" --num_epochs=16 --encoder_name="bert-base-uncased" --product="cosine" --loss="triplet"
...
Step 4. Evaluate Retriever's Ability on our sampled data:
        ...
        DPR:
                python evaluations/retriever_ability_beir.py --beir_dataset_path="/WAVE/datasets/yfang_lab/BEIR" --model_path="/WAVE/users2/unix/jnian/WeakLabelForRAG/train_retriever/output/dpr_weak_1200positive_ibneg_msmarco_qa_v2_train_07_22_22:33" --dataset_name="msmarco"
        Use untrained dpr: 
